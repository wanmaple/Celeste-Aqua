...
namespace Celeste.Mod.Aqua.Rendering
{
    public class SelfCircuitParameters
    {
        ...
        public float RandomStrength { get; set; }
    ...
    public class SelfCircuit : CustomBackground
    {
        ...
        protected override void UpdateUniforms()
        {
            ...
            eff.Parameters["RandomStrength"].SetValue(Arguments.RandomStrength);
        ...
        private void UpdateLineColors()
        {
            ...
            if (eff != null)
            {
                ...
                {
                    Color color = ModInterop.GravityHelper.IsPlayerGravityInverted() ? Arguments.LineColor2 : Arguments.LineColor1;
